    ...
    <section class="container">
            <div class="row">
                    ...
                    <div class="info-block">
                        ...
                        <div class="row middle-xs info-block-row private">
                            <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12  why-text">
                                <h3>Electronero is the leading cryptocurrency with a focus on private and censorship-resistant transactions.</h3>
                                ...
                                <p>Electronero uses cryptography to shield sending and receiving addresses, as well as transacted amounts.</p>
                            </div>
                        ...
                        <div class="row middle-xs info-block-row">
                            ...
                            <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12 why-text">
                                <h3>Electronero transactions are confidential and untraceable.</h3>
                                <p>Every Electronero transaction, by default, obfuscates sending and receiving addresses as well as transacted amounts. This always-on privacy means that every Electronero user's activity enhances the privacy of all other users, unlike selectively transparent cryptocurrencies (e.g. Z-Cash).</p>
                                <p>Electronero is fungible. By virtue of obfuscation, Electronero cannot become tainted through participation in previous transactions. This means Electronero will always be accepted without the risk of censorship.</p>
                        ...
                        <div class="row middle-xs info-block-row">
                            <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12 why-text">
                                <h3>Electronero is a grassroots community attracting the world's best cryptocurrency researchers and engineering talent.</h3>
                                <p>Over <a href="https://www.openhub.net/p/monero" target="_blank" rel="noreferrer noopener">240 developers</a> have contributed to the Electronero project, including 30 core developers. Forums and chat channels are welcoming and active.</p>
                                <p>Electronero's Research Lab, Core Development Team and Community Developers are constantly pushing the frontier of what is possible with cryptocurrency privacy and security.</p>
                                <p>Electronero is not a corporation. It is developed by cryptography and distributed systems experts from all over the world that donate their time or are funded by community donations. This means that Electronero can't be shut down by any one country and is not constrained by any particular legal jurisdiction.</p>
                            </div>
                            <div class="col-lg-5 col-md-6 col-sm-4 col-xs-12 last-sm first-xs center-xs">
                        ...
                        <div class="row middle-xs info-block-row">
                            ...
                            <div class="col-lg-7 col-md-6 col-sm-8 col-xs-12 why-text">
                                <h3>Electronero is electronic cash that allows fast, inexpensive payments to and from anywhere in the world.</h3>
               ...
               <section class="full col-xs-12 monero-vid">
                    <div class="info-block">
                        <div class="row center-xs">
                            <div class="col"><h2>Electronero Videos</h2></div>
                        </div>
                        <div class="row center-xs">
