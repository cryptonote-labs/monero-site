...
* *block_header* - A structure containing block header information.
  ...
  * *difficulty* - unsigned int; The strength of the Masari Supreme network based on mining power.
  ...
  * *nonce* - unsigned int; a cryptographic random one-time number used in mining a Masari Supreme block.
